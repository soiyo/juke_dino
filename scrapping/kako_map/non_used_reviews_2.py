...
def search(place):
    ...
    # 우선 더보기 클릭해서 2페이지
    try:
        driver.find_element_by_xpath('//*[@id="info.search.place.more"]').send_keys(
            Keys.ENTER
        )
        sleep(1)
...
def crawling(place, place_lists):
    ...
    for i, place in enumerate(place_lists):
        ...
        place_name = place.select(".head_item > .tit_name > .link_name")[
            0
        ].text  # place name
        ...
        try:
            ...
            for i in range(page_num - 1):
                ...
                driver.find_element_by_css_selector(
                    "#mArticle > div.cont_evaluation > div.evaluation_review > div > a:nth-child("
                    + str(idx)
                    + ")"
